...
These types are mapped onto XML-RPC types in a straightforward manner:
...
returned result and error codes) of these tasks can then be queried by accessing the
